...
export default function Article() {
  ...
  const randomPosts = structuredClone(data.posts)
  ...
  return (
    <main className=" pt-20 ">
      <section className="bg-[#0a0a0a] min-h-screen">
        <div className=" relative h-16 min-h-96 overflow-hidden">
          <img
            src={post.image}
            alt={post.title}
          ...
          <div className="absolute top-8 right-8 left-8">
            <nav className="inline-flex items-center gap-2 px-4 py-2 bg-black/30 backdrop-blur-md rounded-full text-sm border border-white/10">
              ...
              >
                <i className="fa-solid fa-home text-white/30 text-xs hover:text-white transition-all duration-75"></i>
              </Link>
