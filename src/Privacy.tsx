        ...
        <header className="relative py-20 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <nav className="flex items-center justify-center gap-2 text-sm mb-8">
              ...
              <i className="fa-solid fa-chevron-left w-4 h-4 text-neutral-600 rotate-180 "></i>
            ...
            <div className="inline-flex items-center justify-center w-16 h-16 bg-orange-500/10 backdrop-blur-sm rounded-2xl border border-orange-500/30 mb-6">
              <i className="fa-solid fa-lock w-8 h-8 text-orange-500 text-3xl"></i>
            </div>
          ...
          <div className="bg-orange-500/10 border border-orange-500/20 rounded-2xl p-6 mb-12">
            <div className="flex gap-4">
              <div className="flex-shrink-0">
                <i className="fa-solid fa-shield-halved w-6 h-6 text-orange-500"></i>
              </div>
              <div>
              ...
              <div className="pr-11">
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 text-neutral-400">
                    <i className="fa-solid fa-circle-check w-5 h-5 text-orange-500 flex-shrink-0 mt-0.5"></i>
                    <span>
